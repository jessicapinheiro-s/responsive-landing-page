...
export default function Home() {
  ...
  return (
    <React.Fragment>
      <Header />
      <main className="flex flex-col gap-y-[40px] text-dgrey">
        {/*banner*/}
        <div className="w-full px-[250px] py-[62px]  bg-silver">
          <div className="w-full flex flex-row items-center justify-between gap-[72px]">
            <div className=" flex flex-col gap-[22px] items-start">
              <h1 className="text-[60px] font-semibold">Lessons and insights <span className="text-primary"> <br />from 8 years</span></h1>
        ...
        {/*data info*/}
        <div className="w-full flex flex-row items-center justify-center gap-[54px] px-[250px] py-[44px] bg-silver">
          <div className="w-full text-left ">
            <h1 className="text-[25px] font-semibold text-dgrey">Helping a local <span className="text-primary"> <br />business reinvent itself</span></h1>
        ...
        {/*data info*/}
        <div className="w-full  px-[250px] py-[22px]  ">
          <div className="flex flex-row items-center justify-center gap-[54px] ">
            <div className="w-3/12  ">
              <Image
                src={panaImg}
                alt="panaImg"
        ...
        <div className=" flex flex-col items-center justify-center h-[100%] gap-3 ">
          ...
          <div className="w-full  px-[250px] py-[0px] h-auto ">
            <div className="flex flex-row  justify-between ">
              <div >
                <div className="w-[256px]  rounded-md flex flex-col relative">
                  <div className="z-10">
                    <Image
                      src={img18}
                      alt="img18"
        ...
        {/*text area*/}
        <div className=" flex flex-col min-h-[209px] items-center justify-center py-[22px] px-[0px] gap-[22px]  mt-10">
